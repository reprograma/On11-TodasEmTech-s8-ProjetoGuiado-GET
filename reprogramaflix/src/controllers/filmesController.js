const filmes = require("../models/filmes.json") //chamar json
...
const getByGenre = (request, response)=>{
    ...
    filmes.forEach(filme =>{
                        //String que está em Genre e separa a partir da virgula como referência
        ...
        for(item of generoLista){ // percorri a lista de generos
           //SE o item for igual genero a requisição E SE o filme.Genero tiver esse item
